...
a = 20
b = 10
print(f"adding a + b is equal to {a+b}")
print(f"subtracting a - b is equal to {a-b}")
print(f"multiplying a * b is equal to {a*b}")
print(f"dividing a / b is equal to {a/b}")
print(f"The remainder of a % b is equal to {a%b}")
